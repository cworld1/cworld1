...
- For Chromium-based browsers:
  ...
  Include: Chrome, Edge, Opera, etc.

  Install it on [Chrome Web Store](https://chromewebstore.google.com/detail/pure-new-tab/agnlbedodjakghighoekfbbdnpbebbll)

- For Firefox:

  Install it on [Firefox Add-ons](https://addons.mozilla.org/en-US/firefox/addon/pure-new-tab/)
