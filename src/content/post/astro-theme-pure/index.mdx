...
coverImage: { src: './theme-astro-cover.jpg', alt: 'astro theme pure', color: '#3BA0C5' }
...
在好友的帮助下，我创建了一个新的主题仓库~ 个人精力有限，可能更多交给朋友维护这个主题。希望大家喜欢：

<LinkPreview id='https://github.com/cworld1/astro-theme-pure' />

{/* <!-- <LinkPreview id='https://astro.build/themes/details/pure/' /> --> */}
