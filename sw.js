...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-039bda","is-html-039bda","is-jsdelivr-039bda","is-theme-039bda","is-json-039bda"];
      return Promise.all(
        names
