...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-40f75d","is-html-40f75d","is-jsdelivr-40f75d","is-theme-40f75d","is-json-40f75d"];
      return Promise.all(
        names
