...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-0c3a65","is-html-0c3a65","is-jsdelivr-0c3a65","is-theme-0c3a65","is-json-0c3a65"];
      return Promise.all(
        names
