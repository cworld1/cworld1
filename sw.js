...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-075d3c","is-html-075d3c","is-jsdelivr-075d3c","is-theme-075d3c","is-json-075d3c"];
      return Promise.all(
        names
