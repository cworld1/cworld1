...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-c4dfa1","is-html-c4dfa1","is-jsdelivr-c4dfa1","is-theme-c4dfa1","is-json-c4dfa1"];
      return Promise.all(
        names
