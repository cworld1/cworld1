...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-adbd29","is-html-adbd29","is-jsdelivr-adbd29","is-theme-adbd29","is-json-adbd29"];
      return Promise.all(
        names
