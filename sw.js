...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-eb01e9","is-html-eb01e9","is-jsdelivr-eb01e9","is-theme-eb01e9","is-json-eb01e9"];
      return Promise.all(
        names
