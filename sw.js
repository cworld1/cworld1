...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-f67e9c","is-html-f67e9c","is-jsdelivr-f67e9c","is-theme-f67e9c","is-json-f67e9c"];
      return Promise.all(
        names
