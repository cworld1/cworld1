...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-2bff9f","is-html-2bff9f","is-jsdelivr-2bff9f","is-theme-2bff9f","is-json-2bff9f"];
      return Promise.all(
        names
