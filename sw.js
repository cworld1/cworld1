...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-905032","is-html-905032","is-jsdelivr-905032","is-theme-905032","is-json-905032"];
      return Promise.all(
        names
