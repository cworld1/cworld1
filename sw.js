...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-7fb168","is-html-7fb168","is-jsdelivr-7fb168","is-theme-7fb168","is-json-7fb168"];
      return Promise.all(
        names
